...
class Holiday:
    ...
    def is_available(self, balloon_twister):
...
class Booking:
    def __init__(self, customer, balloon_twister, holiday):
...
class Agent:
    ...
    def remove_balloon_twister(self, balloon_twister):
...
def main():
    ...
    except EOFError: # Ctrl-D on empty line in terminal (Mac) - can't test on Windows! :(
        print()
